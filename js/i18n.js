(function () {
  ...
  var DICT = {
    ...
    'hero.eyebrow': { ru: 'Привет, я', en: 'Hi, I\'m' },
    'hero.subtitle': { ru: 'Дата-инженер — строю пайплайны, которые превращают сырые данные в решения', en: 'Data engineer — building pipelines that turn raw data into decisions' },
    'hero.ctaPrimary': { ru: 'Смотреть проекты', en: 'View projects' },
    'hero.ctaResume': { ru: 'Скачать резюме', en: 'Download resume' },
    'about.title': { ru: 'О себе', en: 'About me' },
